...
/**
 * Data Transfer Object for CustomColumn with enhanced validation and type support.
 */
public class CustomColumnDTO {
    ...
    public CustomColumnDTO(String name, String value) {
        this.name = name;
        this.value = value;
    }
    
    public CustomColumnDTO(String name, String value, CustomColumnType columnType) {
        this.name = name;
        this.value = value;
